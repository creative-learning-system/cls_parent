    ...
    <footer className="hidden border-t border-border bg-card md:block">
      <div className="mx-auto flex max-w-5xl items-center justify-between px-8 py-7">
        ...
        <div className="flex items-center gap-2.5">
          <div className="flex h-6 w-6 items-center justify-center rounded-md gradient-brand overflow-hidden">
            <img src="/favicon.ico" alt="Creative Learning" className="h-4 w-4 object-contain" />
          </div>
